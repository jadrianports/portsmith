/**
 * Shared brand SVG icon component for the edgerunner-v2 template.
 * Extracted from hero.tsx so both Hero and Footer use the same icons (DRY).
 *
 * Supported labels (case-insensitive): github, linkedin, x/twitter, dribbble.
 * Falls back to lucide Globe for unknown labels.
 *
